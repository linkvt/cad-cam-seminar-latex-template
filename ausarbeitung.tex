...
\input{template/packages_and_options}
...
\begin{table}[h]
	\centering
	\captionabove{Beispiel einer Tabelle}
...
% In diesem Template muss man die Quellen manuell eingeben, da sie laut Vorgabe ein bestimmtes Format je nach Typ haben sollten. Die automatische Formatierung wäre mit BibTeX möglich, ist aber aufwendig und deshalb nicht im Template drinnen.
...
\end{thebibliography}
% Fürs Verwenden einer BibTeX-Datei den oberen Teil auskommentieren, bei den folgenden Zeilen den Kommentar entfernen und eine Datei bibliography.bib anlegen.
